  ...
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        ...
        text3="Create stunning thumbnails that gets clicks, without the hassle."
      />
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          Our AI understands what make a video go viral and designs thumbnails
          accordingly.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <p className="text-slate-300 mt-2">
              Stop thinking and start ranking. Our AI creates designs proven to
              capture attention.
            </p>
            <a
